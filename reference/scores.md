...
Information on severity scores at hospital admission for patients
included in the DIVINE cohort. Data was collected at hospital admission.
...
- group_psi::
  ...
  A factor with levels `1`, `2`, `3`, and `4`. PSI group
...
- group_curb65::
  ...
  A factor with levels `1`, `2`, and `3`. CURB65 group
...
- group_mulbsta::
  ...
  A factor with levels `Low-risk` and `High-risk`. MULBSTA group
