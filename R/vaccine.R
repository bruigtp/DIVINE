...
#'   \item{vaccine:}{Is the patient vaccinated for COVID-19?}
#'   \item{complete_vaccine:}{A factor with levels `No`, `Partial` and `Complete`. Is the patient partially vaccinated (one dose of two-dose vaccines), completely vaccinated (one dose for one-dose vaccines or two doses for two-dose vaccines) or not vaccinated at all?}
#'   \item{inmune_vaccine:}{A factor with levels `No immunity`, `Partial immunity` and `Total immunity`. Defines the level of immunity of the patient: not vaccinated (`No immunity`), vaccinated with only one dose for two-dose vaccines (`Partial immunity`), vaccinated with two doses but less than 7 days have passed since the second dose (`Partial immunity`) or vaccinated with all the doses and more than 7 days have passed (`Total immunity`)}
#' }
#'
#' @references
