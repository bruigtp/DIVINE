#' DIVINE's database on treatments previous to hospital admission
#'
...
#'   \item{statins_pre:}{Has the patient }
#'   \item{cortis_pre:}{Previous treatment with corticosteroids}
#'   \item{acei_pre:}{Previous treatment with angiotensin-converting enzyme (ACE) inhibitors}
#'   \item{ara2_pre:}{Previous treatment with angiotensin II receptor antagonists (ARA-II)}
#'   \item{cortis_systemic_pre:}{Routine treatment with systemic corticosteroids}
#'   \item{cortis_inhaled_pre:}{Routine treatment with inhaled corticosteroids}
#'   \item{anticoagulants_pre:}{Previous treatment with anticoagulants}
#'   \item{immunosuppre_pre:}{Usual treatment with immunosuppressants}
#' }
#'
#' @references
